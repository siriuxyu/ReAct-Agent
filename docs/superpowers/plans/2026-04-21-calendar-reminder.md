...
**Goal:** 为 ReAct 个人助手增加 Google Calendar 日程管理和定时提醒功能，支持 Telegram、邮件、GCal 原生三路通知推送。
...
```bash
cd /home/siriux/Projects/ReAct && python -m pytest tests/test_google_oauth.py -v 2>&1 | head -30
```
